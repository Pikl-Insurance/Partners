...
export const colorPaletteTokens: ColorToken[] = [
  {
    ...
    hex: "#006BFF",
    usage: "Primary brand color for buttons and key accents.",
    group: "Brand",
  },
  {
    name: "Sykes blue dark",
    variable: "--brand-primary-dark",
    hex: "#0054CC",
    usage: "Hover and deep brand tone.",
    group: "Brand",
  },
  {
    name: "Sykes blue light",
    variable: "--brand-accent",
    hex: "#3389FF",
    usage: "Secondary accent and chart highlights.",
    group: "Brand",
  },
  {
    name: "Sykes surface",
    variable: "--brand-surface",
    hex: "#EEF5FF",
